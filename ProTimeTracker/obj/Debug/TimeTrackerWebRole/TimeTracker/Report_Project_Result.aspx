<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TimeTracker/MasterPage.master"
    Title="My Company - Time Tracker - Project Report" Culture="auto" UICulture="auto"
    CodeBehind="Report_Project_Result.aspx.cs" Inherits="TimeTrackerWebRole.TimeTracker.Report_Project_Result" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="Server">
    <div id="projectreport">
      ...
      No Data Retrieved.
            ...
            <asp:ObjectDataSource ID="ProjectReportData" runat="server" TypeName="TimeTrackerWebRole.AppCode.BLL.Project"
            ...
            <asp:DataList ID="ProjectList" RepeatColumns="1" RepeatDirection="Vertical" runat="server"
                ...
                <ItemTemplate>
                    <table border="0" cellpadding="0" cellspacing="0" class="Content" width="100%">
                        ...
                        <tr>
                            <td>
                                <asp:ObjectDataSource ID="CategorReportData" runat="server" TypeName="TimeTrackerWebRole.AppCode.BLL.Category"
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" class="Content" width="100%">
                                            ...
                                            <tr>
                                                <td valign="top" colspan="4">
                                                    <img height="15" src="images/spacer.gif" width="1">
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td colspan="2">
                                                    <asp:ObjectDataSource ID="UserReportData" runat="server" TypeName="TimeTrackerWebRole.AppCode.BLL.UserReport"
