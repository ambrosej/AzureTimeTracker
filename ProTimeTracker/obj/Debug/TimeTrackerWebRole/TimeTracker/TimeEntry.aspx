<%@ Page Language="C#" AutoEventWireup="true" Title="My Company - Time Tracker - Log a Time Entry"
    Culture="auto" UICulture="auto" CodeBehind="TimeEntry.aspx.cs" MasterPageFile="~/TimeTracker/MasterPage.master"
    Inherits="TimeTrackerWebRole.TimeTracker.TimeEntry" %>
        ...
        <div id="body">
            <div id="addhours">
                ...
                <fieldset>
                    ...
                    <br />
                    Category<br />
                    <asp:ObjectDataSource ID="ProjectCategories" runat="server" TypeName="TimeTrackerWebRole.AppCode.BLL.Category"
                    ...
                    <asp:CompareValidator ID="CompletionDateCompareValidator" runat="server" Display="Dynamic"
                        ErrorMessage="Date format is incorrect." ControlToValidate="WeekEnding2" Operator="DataTypeCheck"
                        Type="Date">
            ...
            <div id="timesheet">
                <fieldset>
                    ...
                    <legend>Time Sheet For:
                        <asp:ObjectDataSource ID="ProjectMembers" runat="server" TypeName="TimeTrackerWebRole.AppCode.BLL.Project"
                    ...
                    <asp:ObjectDataSource ID="ProjectListDataSource" runat="server" TypeName="TimeTrackerWebRole.AppCode.BLL.TimeEntry"
                        SelectMethod="GetTimeEntries" DeleteMethod="DeleteTimeEntry" UpdateMethod="UpdateTimeEntry"
                    ...
                    <asp:GridView ID="ProjectListGridView" runat="server" DataSourceID="ProjectListDataSource"
                        ...
                        BorderStyle="None" Width="100%" CellPadding="2" PageSize="25" OnRowDeleting="ProjectListGridView_RowDeleting"
                        OnRowUpdated="ProjectListGridView_RowUpdated">
                        <Columns>
