<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/TimeTracker/MasterPage.master"
    Title="My Company - Time Tracker - Manage Projects" Culture="auto" UICulture="auto"
    CodeBehind="Project_Details.aspx.cs" Inherits="TimeTrackerWebRole.TimeTracker.Project_Details" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="Server">
    <div id="adminedit">
        ...
        <fieldset>
                ...
                <tr valign="top">
                    <td width="30%">
                        ...
                        <p>
                            ...
                            <br>
                            <asp:TextBox ID="ProjectName" runat="server" Width="194px" MaxLength="50"></asp:TextBox>
                            ...
                            <br />
                            <asp:TextBox ID="Description" runat="server" TextMode="MultiLine" Width="204px" Columns="20"
                                Rows="8" MaxLength="200"></asp:TextBox>
                            <br />
                    ...
                    <td width="30%">
                        ...
                        <p>
                            ...
                            <asp:ObjectDataSource ID="ProjectConsultantData" runat="server" TypeName="System.Web.Security.Roles"
                                SelectMethod="GetUsersInRole"></asp:ObjectDataSource>
                            <asp:ListBox ID="Consultants" runat="server" SelectionMode="Multiple" Rows="9" DataSourceID="ProjectConsultantData"
                                CssClass="resourcelist" />
                        </p>
                    </td>
                    <td width="40%" runat="server" id="ProjectCategoryColumn">
                        ...
                        <p>
                            ...
                            <asp:RegularExpressionValidator ID="CategoryNameValidator" runat="server" ErrorMessage="Category name must be alphanumeric."
                                ControlToValidate="CategoryName" Display="Dynamic" ValidationExpression="[a-zA-Z0-9 ]*"
                            ...
                            <br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="Abbrev"
                                Display="Dynamic" ErrorMessage="Category abbreviation  is a required value."
                                ValidationGroup="CategoryValidation"></asp:RequiredFieldValidator>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Category abbreviation must be alphanumeric."
                                ControlToValidate="Abbrev" Display="Dynamic" ValidationExpression="[a-zA-Z0-9 ]*"
                                ValidationGroup="CategoryValidation">
                            </asp:RegularExpressionValidator>
                            <br />
                            <asp:Label ID="Label9" runat="server" Text="Label" AssociatedControlID="CatDuration">Duration:</asp:Label>
                            <br />
                            <asp:TextBox ID="CatDuration" runat="server" Width="70px" EnableViewState="False"
                                ValidationGroup="CategoryValidation"></asp:TextBox>
                            <br />
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="CatDuration"
                            ...
                            <asp:RangeValidator ID="RangeValidator2" runat="server" ErrorMessage="Duration is out of range."
                                ControlToValidate="CatDuration" MaximumValue="99999" MinimumValue="0" Type="Integer"
                                ValidationGroup="CategoryValidation">
                            </asp:RangeValidator>
                            <br />
                            ...
                            <asp:ObjectDataSource ID="CategoryData" runat="server" TypeName="TimeTrackerWebRole.AppCode.BLL.Category"
                        ...
                        <p>
                            ...
                            <asp:DropDownList ID="ProjectList" runat="server" Width="190px" DataSourceID="ProjectData"
                                DataValueField="Id" DataTextField="Name" OnPreRender="ProjectList_PreRender" />
                            <br />
            ...
            <div class="formsection">
                <asp:Button ID="SaveButton2" runat="server" CssClass="submit" Text="Save" OnClick="SaveButton_Click">
                </asp:Button>
                &nbsp;
