<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report_Resources.aspx.cs"  Title="My Company - Time Tracker - Create Consultants Reports" Culture="auto" UICulture="auto"   MasterPageFile="~/TimeTracker/MasterPage.Master" Inherits="TimeTrackerWebRole.TimeTracker.Report_Resources" %>
    ...
    <div id="projectreport">
        ...
        <fieldset>
            ...
            <p>
                ...
                <br />
                <asp:ObjectDataSource ID="UserData" runat="server" TypeName="TimeTrackerWebRole.AppCode.BLL.Project" />
