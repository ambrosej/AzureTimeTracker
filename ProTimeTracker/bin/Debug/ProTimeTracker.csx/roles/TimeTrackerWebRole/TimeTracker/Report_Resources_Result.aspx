<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Report_Resources_Result.aspx.cs"
    MasterPageFile="~/TimeTracker/MasterPage.master" Title="My Company - Time Tracker - Resource Reports"
    Culture="auto" UICulture="auto" Inherits="TimeTrackerWebRole.TimeTracker.Report_Resources_Result" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="maincontent" runat="Server">
    <div id="projectreport">
        ...
        <fieldset>
            ...
            <asp:ObjectDataSource ID="UserReportData" runat="server" TypeName="TimeTrackerWebRole.AppCode.BLL.UserTotalDurationReport"
                        ...
                        <asp:DataList ID="UserList" runat="server" Width="100%" DataSourceID="UserReportData"
                            ...
                            <ItemTemplate>
                                ...
                                <table cellspacing="0" cellpadding="3" width="100%" border="0">
                                    <tr>
                                        <td>
                                            <asp:ObjectDataSource ID="TimeEntryData" runat="server" TypeName="TimeTrackerWebRole.AppCode.BLL.TimeEntry"
